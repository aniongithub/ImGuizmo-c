...
def main():
    ...
    sequencer = seq.ImSequencerHandle()
    params = seq.ImSequencerParams()
    result = seq.ImSequencer_createSequencer(params, ctypes.byref(sequencer))
...
def impl_pysdl2_init():
    ...
    window_name = "pyImSequencer example"
